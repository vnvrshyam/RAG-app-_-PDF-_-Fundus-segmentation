...
st.image(image,center=True,use_column_width=True,width=300,  # Set the width to 300 pixels
    height=200)
...
1. **Enter Your API Key**: You'll need a Google API key for the chatbot to access Google's Generative AI models. Obtain your API key at [Google Makersuite](https://makersuite.google.com/app/apikey).
